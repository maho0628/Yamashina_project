...
public class AspectKeeper : MonoBehaviour
{
    ...
    [SerializeField]
    private Vector2 aspectVec; //目的解像度4

    void Update()
    {
        var screenAspect = Screen.width / (float)Screen.height; //画面のアスペクト比1920/1080 1.77777
        var targetAspect = aspectVec.x / aspectVec.y; //目的のアスペクト比  1280/720
